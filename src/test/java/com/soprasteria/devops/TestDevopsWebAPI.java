...
public class TestDevopsWebAPI {
	...
	BaseObj model = new BaseObj("2034", "DEVOPS Accelerator", "Sopra Steria");
	...
	public void checkDetails() throws Exception {
		// 101920201544
		RequestBuilder requestBuilder = MockMvcRequestBuilders.get("/world5").accept(MediaType.APPLICATION_JSON);
		MvcResult result = mockMvc.perform(requestBuilder).andReturn();

		System.out.println("response:::::: " + result.getResponse());

		String expected = "{\"id\": \"2034\",\"projectName\": \"DEVOPS Accelerator\",\"companyName\": \"Sopra Steria\"}";
